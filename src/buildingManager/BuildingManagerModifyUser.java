 ...
 * @author wongj
 */
public class BuildingManagerModifyUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MODIFY ACCOUNT EXEC/ BUILDING EXEC ACCOUNT");
    ...
    private void setDefault() {
        if(userID.startsWith("ACE")) {
            userRoleTF.setText("Account Executive");
        } else if(userID.startsWith("BDE")) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuildingManagerModifyUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
