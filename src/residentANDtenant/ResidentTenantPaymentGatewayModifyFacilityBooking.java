...
public class ResidentTenantPaymentGatewayModifyFacilityBooking extends javax.swing.JFrame {
     ...
     * @param bookingList
     */
    public ResidentTenantPaymentGatewayModifyFacilityBooking(Users user, List<String> bookingList) {
        initComponents();
        setWindowIcon();
        this.user = user;
    ...
    private void bookBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookBtActionPerformed
        ...
        if(result == JOptionPane.YES_OPTION){
            ...
            dispose();
            new ResidentTenantBookedFacility(user).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResidentTenantPaymentGatewayModifyFacilityBooking.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ResidentTenantPaymentGatewayModifyFacilityBooking(null, null).setVisible(true);
            }
        });
    }
