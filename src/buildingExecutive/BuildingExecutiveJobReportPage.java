 ...
 * @author wongj
 */
public class BuildingExecutiveJobReportPage extends javax.swing.JFrame {
     ...
     * @param tableData
     */
    public BuildingExecutiveJobReportPage(BuildingExecutive BE, String reportTitle, ArrayList tableData) {
        initComponents();
        this.BE = BE;
    ...
    private void tableDesign() {
        int[] ignoreColumn = {4};
        int[] columnLength = {90, 95, 100, 105, 303, 95, 120, 100};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuildingExecutiveJobReportPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuildingExecutiveJobReportPage(null, null, null).setVisible(true);
            }
        });
    }
