 ...
 * @author wongj
 */
public class AdminExecutiveResidentTManagement extends javax.swing.JFrame {

    /**
     * Creates new form homePage
     */
    public AdminExecutiveResidentTManagement(Users user) {
        initComponents();
        setWindowIcon();
        this.user = user;
        setCurrentProfile();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(39, 39, 39)
                .addComponent(usernameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 729, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "UNIT NO.", "USER ID", "NAME", "TYPE", "IDENTIFICATION NO.", "PHONE NO.", "ACTION"
            }
        ) {
    ...
    public static AdminExecutiveResidentTManagement adeRTManagement;
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
        ...
        new AdminExecutiveAddResidentTenant(user).setVisible(true);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (column == 6) {
            ...
            new AdminExecutiveModifyResidentTenant(userID, user).setVisible(true);
        }
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        // TODO add your handling code here:
        dispose();
        new AdminExecutiveResidentTManagementHistory(user).setVisible(true);
    ...
    private void setTable() {
        ...
        List<String> availableList = 
                ae.extractAllTenantResident(String.valueOf
        ...
        for (int i = 0; i < availableList.size(); i++) {
            ...
            String idNo = userDetails[5];
            String phoneNo = userDetails[7];
            
            String[] tbData = {unitNo, userID, name, type, idNo, phoneNo, "MANAGE"};
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExecutiveResidentTManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecutiveResidentTManagement(null).setVisible(true);
            }
        });
    }
