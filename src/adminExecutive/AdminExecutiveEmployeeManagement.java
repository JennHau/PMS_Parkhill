...
public class AdminExecutiveEmployeeManagement extends javax.swing.JFrame {
     ...
     */
    public AdminExecutiveEmployeeManagement(Users user) {
        initComponents();
        setWindowIcon();
        this.user = user;
        setCurrentProfile();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(42, 42, 42)
                .addComponent(usernameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 721, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static AdminExecutiveEmployeeManagement adeEmployee;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (column == 5) {
            ...
            new AdminExecutiveModifyEmployee(employeeID, user).setVisible(true);
        }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecutiveEmployeeManagement(null).setVisible(true);
            }
        });
    }
