 ...
 * @author wongj
 */
public class AdminExecutiveBookFacility extends javax.swing.JFrame {

    /**
     * Creates new form homePage
     * @param fb
     */
    public AdminExecutiveBookFacility(Facility fb, Users user) {
        initComponents();
        setWindowIcon();
        this.user = user;
        setCurrentProfile();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(50, 50, 50)
                .addComponent(usernameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 718, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bookBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bookBtActionPerformed
        ...
        dispose();
        new AdminExecutivePaymentGateway(availableList, user).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExecutiveBookFacility.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecutiveBookFacility(null, null).setVisible(true);
            }
        });
    }
