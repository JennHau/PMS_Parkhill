 ...
 * @author wongj
 */
public class AdminExecutiveFacilityManagement extends javax.swing.JFrame {

    /**
     * Creates new form homePage
     */
    public AdminExecutiveFacilityManagement(Users user) {
        initComponents();
        setWindowIcon();
        this.user = user;
        setCurrentProfile();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NO.", "FACILITY ID", "FACILITY NAME", "START TIME", "END TIME", "QUANTITY", "ACTIVE", "ACTION"
            }
        ) {
    ...
    public static AdminExecutiveFacilityManagement adeFacility;
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (column == 7) {
            ...
            new AdminExecutiveModifyFacility(facilityID, user).setVisible(true);
        }
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
        // TODO add your handling code here:
        new AdminExecutiveAddFacility(user).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExecutiveFacilityManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecutiveFacilityManagement(null).setVisible(true);
            }
        });
    }
