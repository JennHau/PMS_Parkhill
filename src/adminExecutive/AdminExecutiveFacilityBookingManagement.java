...
public class AdminExecutiveFacilityBookingManagement extends javax.swing.JFrame {
     ...
     * @param AE
     */
    public AdminExecutiveFacilityBookingManagement(AdminExecutive AE) {
        initComponents();
        setWindowIcon();
        this.AE = AE;
        setCurrentProfile();
    ...
    private void searchTextFieldKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchTextFieldKeyReleased
        ...
        if (!"".equals(searchTextField.getText().toUpperCase())) {
            ...
            for (int i=0; i<tableModel.getRowCount(); i++) {
                ...
                String tmodule_code = String.valueOf(facilityBookingTable.getValueAt(i, 1)).toUpperCase();
    ...
    private void setTableDesign() {
        ...
        AE.setTableDesign(facilityBookingTable, jLabel16, columnLength, colummnIgnore);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecutiveFacilityBookingManagement(null).setVisible(true);
            }
        });
    }
