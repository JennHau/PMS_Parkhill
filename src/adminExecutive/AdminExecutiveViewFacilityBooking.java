...
public class AdminExecutiveViewFacilityBooking extends javax.swing.JFrame {
     ...
     * @param facilityName
     */
    public AdminExecutiveViewFacilityBooking(String facilityID, String facilityName) {
        initComponents();
        setWindowIcon();
    ...
    private void setDefault() {
        facilityTypeLabel.setText(facilityID +" - "+ facilityName);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecutiveViewFacilityBooking(null, null).setVisible(true);
            }
        });
    }
