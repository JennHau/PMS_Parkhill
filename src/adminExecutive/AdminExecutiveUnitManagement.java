...
public class AdminExecutiveUnitManagement extends javax.swing.JFrame {
     ...
     * @param AE
     */
    public AdminExecutiveUnitManagement(AdminExecutive AE) {
        initComponents();
        setWindowIcon();
        this.AE = AE;
        setCurrentProfile();
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
        ...
        new AdminExecutiveAddUnit(AE).setVisible(true);
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        // TODO add your handling code here:
        dispose();
        new AdminExecutiveUnitManagementHistory(AE).setVisible(true);
    ...
    private void setTableDesign() {
        int[] colummnIgnore = {};
        int[] columnLength = {40, 184, 184, 184, 184, 184};
