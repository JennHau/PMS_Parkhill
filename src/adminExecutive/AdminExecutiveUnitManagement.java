 ...
 * @author wongj
 */
public class AdminExecutiveUnitManagement extends javax.swing.JFrame {

    /**
     * Creates new form homePage
     */
    public AdminExecutiveUnitManagement(Users user) {
        initComponents();
        setWindowIcon();
        this.user = user;
        setCurrentProfile();
    ...
    private void initComponents() {
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(37, 37, 37)
                .addComponent(usernameLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 728, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel14.setText("UNIT MANAGEMENT");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NO.", "UNIT NO.", "SQUARE FOOT", "STATUS", "DATE OF SOLD", "ACTION"
            }
        ) {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/historyIcon.png"))); // NOI18N
        ...
        dashboardPanel1.setBackground(new java.awt.Color(13, 24, 42));
        ...
        dashboardLabel1.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        ...
        dashboardPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(dashboardPanel1Layout.createSequentialGroup()
                .addGap(14, 14, 14)
                .addComponent(dashboardLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 115, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
    ...
    public static AdminExecutiveUnitManagement adeUnitManage;
    ...
    private void typeCBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_typeCBActionPerformed
        ...
        setTable();
        if (typeCB.getSelectedItem() == "ISSUED") {
            addPanel.setBackground(Color.GRAY);
        } else if (typeCB.getSelectedItem() == "PENDING") {
            addPanel.setBackground(new Color(13,50,79));
        }
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
        ...
        new AdminExecutiveAddUnit(user).setVisible(true);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (column == 5) {
            ...
            new AdminExecutiveModifyUnit(type, unitNo, squareFoot, user).setVisible(true);
        }
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        // TODO add your handling code here:
        dispose();
        new AdminExecutiveUnitManagementHistory(user).setVisible(true);
    ...
    private void dashboardLabel1MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_dashboardLabel1MouseEntered
        // TODO add your handling code here:
        dashboardLabel1.setCursor(Cursor.getDefaultCursor().getPredefinedCursor(Cursor.HAND_CURSOR));
    }//GEN-LAST:event_dashboardLabel1MouseEntered
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExecutiveUnitManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecutiveUnitManagement(null).setVisible(true);
            }
        });
    }
