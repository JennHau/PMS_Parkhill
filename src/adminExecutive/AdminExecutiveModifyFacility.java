 ...
 * @author wongj
 */
public class AdminExecutiveModifyFacility extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("MODIFY FACILITY");
        ...
        modifyBt.setBackground(new java.awt.Color(13, 24, 42));
    ...
    String facilityID; private final AdminExecutive AE;
    ...
    private void setDefault() {
        ...
        if (fb.isPayment()) {
            ...
            unitCB.setSelectedItem(fb.getPriceUnit());
    ...
    private void deleteBtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtActionPerformed
        ...
        if(result == JOptionPane.YES_OPTION){
            AE.deleteFacility(fctID, fctName);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExecutiveModifyFacility.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
