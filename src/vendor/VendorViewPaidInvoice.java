 ...
 * @author wongj
 */
public class VendorViewPaidInvoice extends javax.swing.JFrame {
     ...
     * @param user
     */
    public VendorViewPaidInvoice(String invoiceNo, Users user, String feeTypes) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendorViewPaidInvoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendorViewPaidInvoice(null, null, null).setVisible(true);
            }
        });
    }
