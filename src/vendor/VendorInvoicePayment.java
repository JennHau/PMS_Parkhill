 ...
 * @author wongj
 */
public class VendorInvoicePayment extends javax.swing.JFrame {
     ...
     * @param user
     */
    public VendorInvoicePayment(String invoiceNo, Users user, String feeTypes) {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendorInvoicePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendorInvoicePayment(null, null, null).setVisible(true);
            }
        });
    }
